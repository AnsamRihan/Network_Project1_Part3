...
def not_found(IP, clientPort):
    website = ''''
        ...
        <html lang="en">
              ...
              <body style="background-image: url('images/Error.jpg'); background-repeat: no-repeat; background-size: cover;">
                    <h1 style="color: red">The File is NOT Found</h1>
                    <p style="text-align: left; font-size: 30px; color: white">
                      <b>
                        <br>
                        1200749 - Ansam Rihan
                        <br>
...
while True:
    ...
    # if the request was cr then go to cornell
    elif request == "cr":
        connection.send("HTTP/1.1 307 Temporary Redirect\r\n".encode())
        connection.send("Location: https://www.cornell.edu/ \r\n".encode())
        connection.send("\r\n".encode())
